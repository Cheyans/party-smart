...
import {getAuthorData, getPartyData, createNewParty} from '../server';
import HostUser from './host-user';


var supplies = [];
var users = [];
//var listItems = {supplies: [], users: []};
...
addInvitees(element, invitee){
  users[invitee].push(element);
}

//adding inputted supplies onto an empty array
addSupplies(element, supply){
  supplies[supply].push(element);
      ...
      <div className="panel panel-default">
         <div className="panel-body">
            <fieldset>
               ...
               <div className="form-group">
                  <input className="form-control" placeholder="Who do you want to invite?" required="true" type="text"  id="invite" />
                    <a className="btn btn-success col-lg-9" href="#" role="button" onClick={()=>this.addInvitees()}>
                    Add Person
                    </a>
             </div>
            </fieldset>
                  ...
                  <div className="col-md-6">
                     <div className="form-group">
                        <input className="form-control" placeholder="What do you need?" required="true" type="text" id="supplies"/>
                          <a className="btn btn-success col-lg-9" href="#" role="button" onClick={()=>this.postParty()}>
                          Add Supply
                          </a>
                     </div>
                     <table className="table table-striped">
