            ...
            <div className="panel-body">
              <fieldset>
                ...
                <div className="form-group">
                  ...
                  <a className="btn btn-success col-lg-9" href="#" role="button" onClick={() => this.addInvitee()}>
                    Add Person
                  </a>
                </div>
              </fieldset>
                ...
                <div className="col-lg-12">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <a className="btn btn-success col-lg-9" href="#" role="button" onClick={() => this.addSupply()}>
                        Add Supply
                      </a>
                    </div>
                    <table className="table table-striped">
